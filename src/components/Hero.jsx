    ...
    <section className={`flex md:flex-row flex-col ${styles.paddingY}`} id='home' >
      <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6`}>
        <div className='flex flex-row items-center py-[6px] px-4 bg-discount-gradient rounded-[10px] mb-2'>
          ...
          <p className={`${styles.paragraph} max-w-[420px] text-white mt-5`}>
      ...
      <div className={`flex-1 flex ${styles.flexCenter} md:my-0 my-10 `}>
        <img src={robot} alt="billing" className='w-[100%] h-[100%] relative z-[5]' />
          ...
          <div className=' absolute z-[1] w-[100%]  rounded-full bottom-40 white'></div>
          <div className=' absolute z-[2] w-[50%] h-[50%] right-20 bottom-20 blue'></div>
      </div>
    </section>
  )
}
